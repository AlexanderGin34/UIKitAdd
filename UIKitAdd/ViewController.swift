...
//  UIKitAdd
//
//  Created by Aleksandr Gineyka on 03.11.2021.
//
...
class ViewController: UIViewController {
    ...
    @IBOutlet var secmentedControl: UISegmentedControl!
    ...
    override func viewDidLoad() {
        ...
        secmentedControl.insertSegment(withTitle: "Third", at: 2, animated: false)
        ...
        slider.thumbTintColor = UIColor(red: 255/233, green: 0/255, blue: 0/255, alpha: 1)
    ...
    @IBAction func controlAction() {
        switch secmentedControl.selectedSegmentIndex {
        case 0:
    ...
    @IBAction func toggleElements(_ sender: Any) {
        secmentedControl.isHidden = !switchForm.isOn
